...
//BASE DE DATOS
	var productos = ["Precesador I7", "Tarjeta Grafica Ga", "Tarjeta Grafica b5",  "Monitor Hp", "Monitor LG", "Case Gamer", "Tarjta Madre force", "Targeta Madre Intel"];
	var imgGrandes = ["img/productos2/1.jpg", "img/productos2/2.jpg", "img/productos2/3.jpg", "img/productos2/4.jpg", "img/productos2/5.jpg", "img/productos2/6.jpg", "img/productos2/7.jpg", "img/productos2/8.jpg"];
	var imgPeque = ["img/productos2/1m.jpg", "img/productos2/2m.jpg", "img/productos2/3m.jpg", "img/productos2/4m.jpg", "img/productos2/5m.jpg", "img/productos2/6m.jpg", "img/productos2/7m.jpg", "img/productos2/8m.jpg"];
	var precios = [121, 112, 125, 210, 122, 123, 100, 120];
	var stock = [12, 2, 8, 3, 10, 14, 3, 11];
...
//FUNCION DE VALIDACION DE DATOS PERSONALES:
	function validaDatosPersonales(elEvento) {
		...
		//Codigo Postal:	
			...
			if( vCodigoPostal=="" || isNaN(vCodigoPostal) ) {
				todoBien=false;
